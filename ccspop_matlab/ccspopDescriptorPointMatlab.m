function feat = ccspopDescriptorPointMatlab( im, param, verbosity )
% CCS-POP Descriptor
% Ver. 0.1
%
...
cnt = 1;
feat = zeros( (max_r - start_r + 1) * 4, 1 ); % *2 is 


for cur_r = start_r:step_r:max_r
    [ feat, cnt ] = computeCCSPOP( im, feat, cnt, ctx, cty, cur_r );
end
